<template>
  ...
  <div class="font-sans text-gray-900 antialiased">
      <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#f8f4f3]">
          <div>
              <a href="/">
                  <h2 class="font-bold text-3xl">S <span class="bg-[#f84525] text-white px-2 rounded-md">Store</span></h2>
              </a>
          </div>
          ...
          <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
              <form method="POST">
                  ...
                  <div>
                      <label class="block font-medium text-sm text-gray-700" for="email" value="Email"></label>
                      <input type='email' 
                          name='email'
                          placeholder='Email'
